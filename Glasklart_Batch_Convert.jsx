...
for(var i=0; i<fileList.length; i++) { // loop trough input files
    ...
    generateGlasklartIcon(78, 21, sourceFile, templateFile1, outputFolder+"/@2x", docName+"@2x");           // generates 120px Glasklart icon (@2x)      | you can comment
    generateGlasklartIcon(100, 26, sourceFile, templateFile2, outputFolder+"/iPad@2x", docName+"~iPad@2x"); // generates 152px Glasklart icon (~ipad@2x) | out what you
